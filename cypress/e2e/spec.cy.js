...
describe("User login", () => { 
  it("should allow user to log in with valid credentials", () => {
    ...
    cy.get("input#email")
      ...
      .type("111202214014@mhs.dinus.ac.id")
      .should("have.value", "111202214014@mhs.dinus.ac.id");
  ...
  it("should show error when student email is missing @ symbol", () => {
    ...
    cy.get("input#email")
      .should("be.visible")
      .should("have.attr", "placeholder", "hello@example.com")
      .type("111202214014mhs.dinus.ac.id")
      .should("have.value", "111202214014mhs.dinus.ac.id");
  ...
  it("should show error when student email is missing domain", () => {
    ...
    cy.get("input#email")
      ...
      .should("have.attr", "placeholder", "hello@example.com")
      .type("111202214014@")
      .should("have.value", "111202214014@");
  ...
  it("should show error when student email is missing dot", () => {
    ...
    cy.get("input#email")
      .should("be.visible")
      .should("have.attr", "placeholder", "hello@example.com")
      .type("111202214014@mhsdinusacid")
      .should("have.value", "111202214014@mhsdinusacid");
